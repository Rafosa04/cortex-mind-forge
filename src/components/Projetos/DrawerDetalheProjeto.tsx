  ...
  return (
    <>
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerContent className="w-full max-w-7xl mx-auto rounded-t-2xl md:rounded-l-2xl md:rounded-t-none h-[95vh] glass-morphism shadow-xl border-l-2 border-[#60B5B5]/40">
          <DrawerHeader className="border-b border-[#60B5B5]/20">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="w-96 border-l border-[#60B5B5]/20 overflow-y-auto bg-[#141429]/30">
              <AthenaProjectInsights projeto={localProjeto} />
            </div>
          </div>
          
          <div className="border-t border-[#60B5B5]/20 p-4">
            <DrawerClose asChild>
